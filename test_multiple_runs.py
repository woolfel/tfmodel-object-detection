...
flags.DEFINE_string('pipeline_config_path', None, 'Path to pipeline config '
                    'file.')
flags.DEFINE_string('frozengraph', '', 'the filename of the frozen graph.')
FLAGS = flags.FLAGS
...
def main(_):
  ...
  assert FLAGS.frozengraph, 'frozen graph path missing.'
  ...
  if FLAGS.image:
    ...
    with detection_graph.as_default():
      ...
      with tf.gfile.GFile(FLAGS.frozengraph, 'rb') as f:
